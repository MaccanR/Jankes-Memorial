...
const translations = {
    ...
    'kesäkuuta': 'kesäkuuta',
    'heinäkuuta': 'heinäkuuta',
    'elokuuta': 'elokuuta',
    'syyskuuta': 'syyskuuta',
    'lokakuuta': 'lokakuuta',
    'marraskuuta': 'marraskuuta',
    'joulukuuta': 'joulukuuta',
    // Footer
    '© Jankesin perheen muistosivusto': '© Jankesin perheen muistosivusto',
    'Sivusto on tarkoitettu muistamiseen ja kunnioitukseen.': 'Sivusto on tarkoitettu muistamiseen ja kunnioitukseen.',
    // Index page
    'Hautakirjan vainajat': 'Hautakirjan vainajat',
    'Hautakirja': 'Hautakirja',
    'Tietoa tästä muistosivusta': 'Tietoa tästä muistosivusta',
    'about-section-description': 'Tämä verkkosivusto on omistettu Jankesin suvun elämän, muistojen ja perinnön kunnioittamiselle. Tälle verkkosivulle tallennetut hautakirjan tiedot on haettu Geni palvelusta (Geni.com on sukututkimukseen liittyvä Internetin yhteisöpalvelu), Helsingin seurakuntayhtymän hautarekisteristä ja eri henkilöiden Jankes sukuun liittyvistä selvityksistä. Sivun ylläpitäjä ei vastaa tietojen oikeellisuudesta. Jos sinulla huomautettavaa asiasisällöstä ole ystävällisesti yhteydessä Kari Roos p. 040 6717189 tai Henrik Jankes p. 040 9003242.',
    ...
    'Tämä verkkosivusto on omistettu Jankesin suvun elämän, muistojen ja perinnön kunnioittamiselle. Sivusto tarjoaa rauhallisen paikan muistamiselle, hiljentymiselle ja niiden arvojen arvostamiselle, jotka on siirretty sukupolvelta toiselle.': 'Tämä verkkosivusto on omistettu Jankesin suvun elämän, muistojen ja perinnön kunnioittamiselle. Sivusto tarjoaa rauhallisen paikan muistamiselle, hiljentymiselle ja niiden arvojen arvostamiselle, jotka on siirretty sukupolvelta toiselle.',
    'hautakirja-info-box': 'Klikkaamalla vainajan nimeä aukeaa uusi sivu. Tällä sivulla on vainajan henkilökohtaiset tiedot ja sinne omaisten toimesta tallennetut muistot.',
    'Kuvagallerian paikkamerkit, kuvat voidaan lisätä myöhemmin.': 'Kuvagallerian paikkamerkit, kuvat voidaan lisätä myöhemmin.',
    'Ylhäältä vasemmalta:': 'Ylhäältä vasemmalta:',
    'Seuraava kaksoisrivi, vasemmalta:': 'Seuraava kaksoisrivi, vasemmalta:',
    'Keskikenttä, vasemmalta oikealle:': 'Keskikenttä, vasemmalta oikealle:',
    'Ins. Lindblom \ Rouva Tallberg, Rovasti Engström, Georg Jankes (hieman muiden edessä), Gunnar Kraft, Hovineuvos Nyberg \ Rouva Nyberg': 'Ins. Lindblom \ Rouva Tallberg, Rovasti Engström, Georg Jankes (hieman muiden edessä), Gunnar Kraft, Tuomioistuinneuvosto Nyberg \ Rouva Nyberg',
    'Rovasti Engström': 'Rovasti Engström',
    'Hovineuvos Nyberg \ Rouva Nyberg': 'Tuomioistuinneuvosto Nyberg \ Rouva Nyberg',
    'hovineuvos-nyberg-line': 'Tuomioistuinneuvosto Nyberg \\ Rouva Nyberg',
    'Emmy Sidorow \ Mandi Ahlgren \ Elsa Jankes, Konstantin Sidorow \ Rouva Sidorow': 'Emmy Sidorow \ Mandi Ahlgren \ Elsa Jankes, Konstantin Sidorow \ Rouva Sidorow',
    'Hannes Ahlgren \ Rouva Lindblom o.s. Sidorow, Hulda Järnmark, Hulda Thorell': 'Hannes Ahlgren \ Rouva Lindblom o.s. Sidorow, Hulda Järnmark, Hulda Thorell',
    'Eturivi, vasemmalta:': 'Eturivi, vasemmalta:',
    'edempänä': 'edempänä',
    'hieman muiden edessä': 'hieman muiden edessä',
    'o.s.': 'o.s.',
    'ja': 'ja',
    'Alkuperäinen valokuva skannattu suvun arkistoista ja teksti uudelleen kirjoitettu 13.11.2013': 'Alkuperäinen valokuva skannattu suvun arkistoista ja teksti uudelleen kirjoitettu 13.11.2013',
  ...
  sv: {
    ...
    'Lähisukulaiset': 'Närmaste släktingar',
    'Tiedoa': 'Information',
    'Sukupuoli:': 'Kön:',
    'Syntynyt:': 'Född:',
    'Kuollut:': 'Död:',
    ...
    'Helsingissä': 'i Helsingfors',
    'Sukuhauta': 'Familjegrav',
    'Jankesin': 'Jankes',
    'Ammatti:': 'Yrke:',
    ...
    // Index page
      ...
      'Hautakirja': 'Dödbok',
    'Tietoa tästä muistosivusta': 'Om denna minnessida',
    'about-section-description': 'Denna webbplats är tillägnad släkten Jankes liv, minnen och arv. Uppgifterna i dödboken på denna webbplats har hämtats från tjänsten Geni (Geni.com är en webbtjänst för släktforskning), Helsingfors kyrkliga samfällighets gravregister och olika utredningar som rör släkten Jankes. Webbplatsens administratör ansvarar inte för uppgifternas riktighet. Om du har synpunkter på innehållet, vänligen kontakta Kari Roos tfn 040 6717189 eller Henrik Jankes tfn 040 9003242.',
    'Muistoja valokuvissa': 'Minnen i fotografier',
    'Valokuvia': 'Fotografier',
    'Kuvat': 'Bilder',
    'Henkilöiden tunnistus': 'Identifiering av personerna',
    'Rakkaudella muistaen ja kiitollisuudella kunnioittaen': 'Med tacksamhet och högaktning ihågkommer vi våra kära',
    'Tämä verkkosivusto on omistettu Jankesin suvun elämän, muistojen ja perinnön kunnioittamiselle. Sivusto tarjoaa rauhallisen paikan muistamiselle, hiljentymiselle ja niiden arvojen arvostamiselle, jotka on siirretty sukupolvelta toiselle.': 'Den här webbplatsen är tillägnad släkten Jankes liv, minnen och arv. Webbplatsen erbjuder en lugn plats för att minnas, för stund och för att värdesätta de värden som överförts från generation till generation.',
    'hautakirja-info-box': 'Genom att klicka på den avlidnas namn öppnas en ny sida. På denna sida finns den avlidnas personuppgifter och de minnen som släktingar har sparat.',
    'Kuvagallerian paikkamerkit, kuvat voidaan lisätä myöhemmin.': 'Platshållare för bildgalleriet, bilder kan läggas till senare.',
    'Ylhäältä vasemmalta:': 'Från övre vänster:',
    'Seuraava kaksoisrivi, vasemmalta:': 'Följande dubbelrad, från vänster:',
    'Keskikenttä, vasemmalta oikealle:': 'Mittfältet, från vänster till höger:',
    'Ins. Lindblom \ Rouva Tallberg, Rovasti Engström, Georg Jankes (hieman muiden edessä), Gunnar Kraft, Hovineuvos Nyberg \ Rouva Nyberg': 'Ing. Lindblom \ Fru Tallberg, Prosten Engström, Georg Jankes (litet framför de andra), Gunnar Kraft, Hovrådet Nyberg \ Fru Nyberg',
    'Rovasti Engström': 'Prosten Engström',
    'Hovineuvos Nyberg \ Rouva Nyberg': 'Hovrådet Nyberg \ Fru Nyberg',
    'hovineuvos-nyberg-line': 'Hovrådet Nyberg \\ Fru Nyberg',
    'Emmy Sidorow \ Mandi Ahlgren \ Elsa Jankes, Konstantin Sidorow \ Rouva Sidorow': 'Emmy Sidorow \ Mandi Ahlgren \ Elsa Jankes, Konstantin Sidorow \ Fru Sidorow',
    'Hannes Ahlgren \ Rouva Lindblom o.s. Sidorow, Hulda Järnmark, Hulda Thorell': 'Hannes Ahlgren \ Fru Lindblom f. Sidorow, Hulda Järnmark, Hulda Thorell',
    'Eturivi, vasemmalta:': 'Främsta raden, från vänster:',
    'edempänä': 'längre fram',
    'hieman muiden edessä': 'litet framför de andra',
    'o.s.': 'f.',
    'ja': 'och',
    'Alkuperäinen valokuva skannattu suvun arkistoista ja teksti uudelleen kirjoitettu 13.11.2013': 'Originalfotot inskannat och texten renskriven från släktens egna arkiv 13.11.2013',
  ...
  en: {
    ...
    'Tämä verkkosivusto on omistettu Jankesin suvun elämän, muistojen ja perinnön kunnioittamiselle. Sivusto tarjoaa rauhallisen paikan muistamiselle, hiljentymiselle ja niiden arvojen arvostamiselle, jotka on siirretty sukupolvelta toiselle.': 'This website is dedicated to honoring the life, memories and legacy of the Jankes family. The site offers a peaceful place for remembrance, reflection, and appreciation of the values passed from one generation to the next.',
    ...
    'Ins. Lindblom \ Rouva Tallberg, Rovasti Engström, Georg Jankes (hieman muiden edessä), Gunnar Kraft, Hovineuvos Nyberg \ Rouva Nyberg': 'Eng. Lindblom \\ Mrs. Tallberg, Provost Engström, Georg Jankes (slightly in front of others), Gunnar Kraft, Supreme Council Nyberg \\ Mrs. Nyberg',
    'Rovasti Engström': 'Provost Engström',
    'Hovineuvos Nyberg \ Rouva Nyberg': 'Supreme Council Nyberg \\ Mrs. Nyberg',
    'hovineuvos-nyberg-line': 'Supreme Council Nyberg \\ Mrs. Nyberg',
    ...
    'o.s.': 'née',
    'Alkuperäinen valokuva skannattu suvun arkistoista ja teksti uudelleen kirjoitettu 13.11.2013': 'Original photo scanned and text retyped from the family\'s own archives 13 Nov 2013',
...
// Päivitä kielenpainikkeiden tila
